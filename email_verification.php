...
{
$code=$_GET['code'];
$sql=mysqli_query($con,"SELECT * DB_NAME WHERE activationcode='$code'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
  
$st=0;
$result =mysqli_query($con,"SELECT id FROM DB_NAME WHERE activationcode='$code' and status='$st'");
$result4=mysqli_fetch_array($result);   

if($result4>0) 
  {
$st=1;
$result1=mysqli_query($con,"UPDATE DB_NAME SET status='$st' WHERE activationcode='$code'");
echo "<script>
Swal.fire('Account Verified and Activated !!',
'You have verified your account and are a part of Epitomia family :)<br><br><b>Please login with the username and password sent on your registered mail along with verification link.</b>',
'success'
...
'You have already verified your account and are a part of Epitomia family :)<br><br><b>Please directly login with the username and password sent on your registered mail along with verification link.</b>',
'info'
